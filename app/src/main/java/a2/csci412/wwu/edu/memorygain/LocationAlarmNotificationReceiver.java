...
public class LocationAlarmNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setAutoCancel(true)
                ...
                .setContentText("It's time to recall your location.")
                .setDefaults(Notification.DEFAULT_LIGHTS | Notification.DEFAULT_SOUND)
                .setContentInfo("Go to 'Location Recall'")
                .setVibrate(pattern);
        ...
        MainActivity.setLocationGuessReady(true);
    }
}